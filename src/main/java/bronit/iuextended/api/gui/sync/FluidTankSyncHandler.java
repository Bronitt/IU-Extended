package bronit.iuextended.api.gui.sync;
...
public class FluidTankSyncHandler extends ValueSyncHandler<FluidStack> {
    ...
    public static final int SYNC_BUCKET_INPUT = 1;
    public static final int SYNC_BUCKET_OUTPUT = 2;
...
//    private final ModularSlot bucketInputSlot;
//    private final ModularSlot bucketOutputSlot;
    ...
    public FluidTankSyncHandler(IFluidTank fluidTank/*, ModularSlot bucketInputSlot, ModularSlot bucketOutputSlot*/) {
        this.fluidTank = fluidTank;
        this.fluidHandler = FluidTankHandler.getTankFluidHandler(fluidTank);
//        this.bucketOutputSlot = bucketOutputSlot;
//        this.bucketInputSlot = bucketInputSlot;
    }
...
//        if (!this.registered) {
//           this.bucketInputSlot.initialize(this, this.isPhantom());
//
//           this.getSyncManager().getContainer().registerSlot(this.getSyncManager().getPanelName(), this.slot);
//            this.registered = true;
//        }
//
//        this.lastStoredItem = this.getSlot().getStack().copy();
//    }
...
//                tryScrollPhantom(MouseData.readPacket(buf));
    ...
    public FluidTankSyncHandler phantom(boolean phantom) {
        this.phantom = phantom;
        return this;
    }

    public FluidTankSyncHandler controlsAmount(boolean controlsAmount) {
    ...
    public FluidTankSyncHandler canDrainSlot(boolean canDrainSlot) {
        this.canDrainSlot = canDrainSlot;
        return this;
    }

    public FluidTankSyncHandler canFillSlot(boolean canFillSlot) {
